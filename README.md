...
Starting from version v1_beta.0.1, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/buy/offer/v1_beta/',
        'headers'=>[
